...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "${BUILT_PRODUCTS_DIR}/PerfittPartners_iOS/PerfittPartners_iOS.framework/UserInfoAlert.nib"
  ...
  install_resource "${PODS_ROOT}/../../PerfittPartners_iOS/Classes/UserInfoAlert.swift"

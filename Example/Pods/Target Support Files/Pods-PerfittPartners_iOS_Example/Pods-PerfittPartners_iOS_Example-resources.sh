...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "${BUILT_PRODUCTS_DIR}/PerfittPartners_iOS/PerfittPartners_iOS.framework/SizePicker.nib"
  ...
  install_resource "${PODS_ROOT}/../../PerfittPartners_iOS/Classes/PartnersVC.swift"
  install_resource "${PODS_ROOT}/../../PerfittPartners_iOS/Classes/PerfittCameraVC.swift"
  install_resource "${PODS_ROOT}/../../PerfittPartners_iOS/Classes/PerfittKitCameraVC.swift"
  install_resource "${PODS_ROOT}/../../PerfittPartners_iOS/Classes/PerfittKitTutorialVC.swift"
  install_resource "${PODS_ROOT}/../../PerfittPartners_iOS/Classes/PerfittPartners.swift"
  install_resource "${PODS_ROOT}/../../PerfittPartners_iOS/Classes/SizePicker.swift"
  install_resource "${PODS_ROOT}/../../PerfittPartners_iOS/Classes/VideoView.swift"
